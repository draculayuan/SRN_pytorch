...
class SRN(nn.Module):
    ...
    def _multi_proposals(self, rpn_pred_fs,  rpn_pred_ss, multi_rpn_proposal_fn, fpn_level, topN,
        ...
        for level in range(fpn_level):
            ...
            if self.training:
                ...
                if proposals.size > 0:
                    proposals_all.append(proposals)
        if not self.training: # NMS only for inference
            if len(proposals_all) > 0:
                ...
                for b_ix in range(batch_size):
                    ...
                    for cls in range(1, num_classes + 1):
                        ...
                        post_bboxes = pre_bboxes[keep_index[:750]] # keep top 750 per class during nms
    ...
    def forward(self, input):
        ...
        if self.training:
            ...
            outputs['predict'].append(proposals.cuda()) #you cant do .cuda for train cuz train is returning a list. But why do you still have to convert them to cuda? 
        return outputs
